...
const char * const lookupTableAccHardware[] = {
    ...
    "BMI160", "BMI270", "BMI088", "ASM330LHH", "LSM6DS3", "LSM6DSL", "LSM6DSO", "QMI8658", "SH3001","BMI323", "SC7I22", "SC7U22", "FAKE"
};
...
#ifdef USE_TPA_MODE
    { PARAM_NAME_TPA_MODE,          VAR_UINT8  | PROFILE_RATE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_TPA_MODE }, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaMode) },
#endif
...
// PG_IMU_CONFIG
    { "imu_dcm_kp",                 VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 32000 }, PG_IMU_CONFIG, offsetof(imuConfig_t, imu_dcm_kp) },
    { "imu_dcm_ki",                 VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 32000 }, PG_IMU_CONFIG, offsetof(imuConfig_t, imu_dcm_ki) },
...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_ANGLE_LIMIT,       VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 10, 90 }, PG_PID_PROFILE, offsetof(pidProfile_t, levelAngleLimit) },
